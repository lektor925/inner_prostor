...
MVP в разработке. Сделано (шаги 1-5 из ADR, раздел «Рекомендуемый порядок
...
новые позиции с антидубль-шагом (ADR-007/ADR-011/ADR-012). Поиск проверен
и на sqlite-фолбэке, и на реальном Postgres 17 с `pg_trgm`. Впереди —
деплой (шаг 7).
